...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='/kaggle/working/Variations-of-SFANet-for-Crowd-Counting/datasets/part_A_save',
                        help='training data directory')
    parser.add_argument('--save-dir', default='/kaggle/working/Variations-of-SFANet-for-Crowd-Counting/datasets/weights',
    ...
    parser.add_argument('--max-epoch', type=int, default=1600,
